 ...
 * 软件内使用的图标。
 *
 * 规格对齐思源内置图标：24x24 viewBox、单一路径、fill 取 currentColor，
...
<path d="M3.5 6.9a1.6 1.6 0 0 1 1.6-1.6h10.6a1.6 1.6 0 1 1 0 3.2H5.1a1.6 1.6 0 0 1-1.6-1.6Z"/>
<path d="M17.9 5.7a.85.85 0 0 1 .85-.85h.5a.85.85 0 0 1 .85.85v2.4a.85.85 0 0 1-.85.85h-.5a.85.85 0 0 1-.85-.85V5.7Z"/>
